...
| `puertorico` | Puerto Rico Spanish street types, secondary designators, urbanization keywords, the urbanization names that stand alone without URB, and the rural route and highway contract route words. |
